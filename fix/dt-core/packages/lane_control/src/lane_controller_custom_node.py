...
from std_msgs.msg import String, Int8, Empty, Bool, Header
...
class LaneControllerNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.sub_centres = rospy.Subscriber(
            "/duckie/vehicle_detection_node/centers",
            VehicleCorners,
        ...
        self.possible_turns = [2]  # left, straight, right [0, 1, 2]
        self.tags_to_turns = {
                63: [0, 1],
                59: [1, 2],
                67: [0, 2],
        ...
        self.sub_apriltag = rospy.Subscriber(
            "/duckie/apriltag_detector_node/detections",
        ...
        # LED control
        rospy.wait_for_service("/duckie/led_emitter_node/set_pattern")
        self.led_svc = rospy.ServiceProxy(
            "/duckie/led_emitter_node/set_pattern", ChangePattern,
        )
